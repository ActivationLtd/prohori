...
use App\Observers\ApiresponseObserver;
 ...
 * @method static \Illuminate\Database\Query\Builder|\App\Apiresponse onlyTrashed()
 * @method static bool|null restore()
 * @method static \Illuminate\Database\Query\Builder|\App\Apiresponse withTrashed()
 * @method static \Illuminate\Database\Query\Builder|\App\Apiresponse withoutTrashed()
 * @mixin \Eloquent
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Apiresponse newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Apiresponse newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Apiresponse query()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Apiresponse whereBeaconId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Apiresponse whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Apiresponse whereCreatedBy($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Apiresponse whereDeletedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Apiresponse whereDeletedBy($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Apiresponse whereEvent($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Apiresponse whereHeader($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Apiresponse whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Apiresponse whereIsActive($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Apiresponse whereLbEnv($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Apiresponse whereName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Apiresponse wherePartnerEnv($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Apiresponse wherePartnerId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Apiresponse wherePartnerName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Apiresponse whereResponse($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Apiresponse whereSourceUrl($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Apiresponse whereTenantId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Apiresponse whereUpdatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Apiresponse whereUpdatedBy($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Apiresponse whereUuid($value)
...
class Apiresponse extends Basemodule
{
    ...
    {
        $rules = [
            //'name' => 'required|between:1,255|unique:apiresponses,name,' . (isset($element->id) ? "$element->id" : 'null') . ',id,deleted_at,NULL',
    ...
    {
        parent::boot();
        Apiresponse::observe(ApiresponseObserver::class);
        ...
        // completed yet.
        /************************************************************/
        // static::creating(function (Apiresponse $element) { });

        /************************************************************/
        // Following code block executes - after an element is created
        // for the first time.
        /************************************************************/
        // static::created(function (Apiresponse $element) { });
        ...
        // not yet complete.
        /************************************************************/
        // static::updating(function (Apiresponse $element) {});

        /************************************************************/
        // Following code block executes - after an element
        // is successfully updated
        /************************************************************/
        //static::updated(function (Apiresponse $element) {});

        /************************************************************/
        // Execute codes during saving (both creating and updating)
        /************************************************************/
        // static::saving(function (Apiresponse $element) {
        //     $valid = true;
        //     /************************************************************/
        ...
        /************************************************************/
        // static::saved(function (Apiresponse $element) {});
        ...
        /************************************************************/
        // static::deleting(function (Apiresponse $element) {});

        /************************************************************/
        // Following code block executes - after an element is
        // successfully deleted.
        /************************************************************/
        // static::deleted(function (Apiresponse $element) {});

        /************************************************************/
        // Following code block executes - when an already deleted element
        // is in the process of being restored.
        /************************************************************/
        // static::restoring(function (Apiresponse $element) {});

        /************************************************************/
        // Following code block executes - after an element is
        // successfully restored.
        /************************************************************/
        //static::restored(function (Apiresponse $element) {});
    }
