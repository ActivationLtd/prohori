...
use App\Observers\AssignedlocationObserver;
 ...
 * @method static \Illuminate\Database\Query\Builder|\App\Assignedlocation onlyTrashed()
 * @method static bool|null restore()
 * @method static \Illuminate\Database\Query\Builder|\App\Assignedlocation withTrashed()
 * @method static \Illuminate\Database\Query\Builder|\App\Assignedlocation withoutTrashed()
 * @mixin \Eloquent
 * @property-read \App\User $creator
 * @property-read \App\User $updater
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Assignedlocation newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Assignedlocation newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Assignedlocation query()
 */
class Assignedlocation extends Basemodule
{
    //use IsoModule;
    /**
    ...
    {
        $rules = [
            //'name' => 'required|between:1,255|unique:assignedlocations,name,' . (isset($element->id) ? "$element->id" : 'null') . ',id,deleted_at,NULL',
    ...
    {
        parent::boot();
        Assignedlocation::observe(AssignedlocationObserver::class);

        /************************************************************/
        // Execute codes during saving (both creating and updating)
        /************************************************************/
        static::saving(function (Assignedlocation $element) {
            $valid = true;
            $element->name=$element->user->name. " Assigned to ".$element->client->name;
            /************************************************************/
        ...
        // completed yet.
        /************************************************************/
        static::creating(function (Assignedlocation $element) {
            if(isset($element->user_id)){
                $element->user->update([
                    'client_id'=>$element->client_id,
                    'clientlocation_id'=>$element->clientlocation_id
                ]);
            }
        });
        ...
        // for the first time.
        /************************************************************/
        // static::created(function (Assignedlocation $element) { });
        ...
        // not yet complete.
        /************************************************************/
        // static::updating(function (Assignedlocation $element) {});

        /************************************************************/
        // Following code block executes - after an element
        // is successfully updated
        /************************************************************/
        //static::updated(function (Assignedlocation $element) {});

        /************************************************************/
        // Execute codes after model is successfully saved
        /************************************************************/
        // static::saved(function (Assignedlocation $element) {});
        ...
        /************************************************************/
        // static::deleting(function (Assignedlocation $element) {});

        /************************************************************/
        // Following code block executes - after an element is
        // successfully deleted.
        /************************************************************/
        // static::deleted(function (Assignedlocation $element) {});

        /************************************************************/
        // Following code block executes - when an already deleted element
        // is in the process of being restored.
        /************************************************************/
        // static::restoring(function (Assignedlocation $element) {});

        /************************************************************/
        // Following code block executes - after an element is
        // successfully restored.
        /************************************************************/
        //static::restored(function (Assignedlocation $element) {});
    }
