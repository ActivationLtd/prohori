...
use App\Observers\CharityselectionObserver;
 ...
 * @method static \Illuminate\Database\Query\Builder|\App\Charityselection onlyTrashed()
 * @method static bool|null restore()
 * @method static \Illuminate\Database\Query\Builder|\App\Charityselection withTrashed()
 * @method static \Illuminate\Database\Query\Builder|\App\Charityselection withoutTrashed()
 * @mixin \Eloquent
 * @property int|null $share_percentage
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Charityselection newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Charityselection newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Charityselection query()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Charityselection whereCharityId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Charityselection whereCharityName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Charityselection whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Charityselection whereCreatedBy($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Charityselection whereDeletedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Charityselection whereDeletedBy($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Charityselection whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Charityselection whereIsActive($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Charityselection whereName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Charityselection whereSharePercentage($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Charityselection whereTenantId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Charityselection whereUpdatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Charityselection whereUpdatedBy($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Charityselection whereUserEmail($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Charityselection whereUserId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Charityselection whereUserName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Charityselection whereUuid($value)
 * @property string|null $user_uuid
 * @property string|null $charity_uuid
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Change[] $changes
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Upload[] $uploads
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Charityselection whereCharityUuid($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Charityselection whereUserUuid($value)
 * @property-read \App\Charity|null $charity
 * @property-read \App\Upload $latestUpload
 * @property-read \App\User|null $user
 */
class Charityselection extends Basemodule
{
    use IsoModule;
    /**
    ...
    {
        $rules = [
            //'name' => 'required|between:1,255|unique:charityselections,name,' . (isset($element->id) ? "$element->id" : 'null') . ',id,deleted_at,NULL',
    ...
    {
        parent::boot();
        Charityselection::observe(CharityselectionObserver::class);
        ...
        // completed yet.
        /************************************************************/
        // static::creating(function (Charityselection $element) { });

        /************************************************************/
        // Following code block executes - after an element is created
        // for the first time.
        /************************************************************/
        // static::created(function (Charityselection $element) { });
        ...
        // not yet complete.
        /************************************************************/
        // static::updating(function (Charityselection $element) {});

        /************************************************************/
        // Following code block executes - after an element
        // is successfully updated
        /************************************************************/
        //static::updated(function (Charityselection $element) {});

        /************************************************************/
        // Execute codes during saving (both creating and updating)
        /************************************************************/
        static::saving(function (Charityselection $element) {
            $valid = true;
            /************************************************************/
            ...
            if ($element->user()->exists()) {
                $user = $element->user;
                $element->user_uuid = $user->uuid;
                $element->user_name = $user->name;
                $element->user_email = $user->email;
            }

            if ($element->charity()->exists()) {
                $user = $element->charity;
                $element->charity_uuid = $user->uuid;
                $element->charity_name = $user->name;
            }

            if ($valid) {
                $element->name = $element->user_name . " - " . $element->share_percentage . '% - ' . $element->charity_name;
                $element->is_active = 1;
            }
        ...
        /************************************************************/
        // static::saved(function (Charityselection $element) {});
        ...
        /************************************************************/
        // static::deleting(function (Charityselection $element) {});

        /************************************************************/
        // Following code block executes - after an element is
        // successfully deleted.
        /************************************************************/
        // static::deleted(function (Charityselection $element) {});

        /************************************************************/
        // Following code block executes - when an already deleted element
        // is in the process of being restored.
        /************************************************************/
        // static::restoring(function (Charityselection $element) {});

        /************************************************************/
        // Following code block executes - after an element is
        // successfully restored.
        /************************************************************/
        //static::restored(function (Charityselection $element) {});
    }
