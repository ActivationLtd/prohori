...
use App\Observers\ConversionrateObserver;
 ...
 * @method static \Illuminate\Database\Query\Builder|\App\Conversionrate onlyTrashed()
 * @method static bool|null restore()
 * @method static \Illuminate\Database\Query\Builder|\App\Conversionrate withTrashed()
 * @method static \Illuminate\Database\Query\Builder|\App\Conversionrate withoutTrashed()
 * @mixin \Eloquent
 * @property string|null $data
 * @property float|null $rate_u2e
 * @property float|null $rate_u2g
 * @property float|null $rate_e2u
 * @property float|null $rate_e2g
 * @property float|null $rate_g2u
 * @property float|null $rate_g2e
 * @property string|null $data_time
 * @property-read \App\User|null $creator
 * @property-read \App\User|null $updater
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Conversionrate newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Conversionrate newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Conversionrate query()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Conversionrate whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Conversionrate whereCreatedBy($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Conversionrate whereData($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Conversionrate whereDataTime($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Conversionrate whereDeletedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Conversionrate whereDeletedBy($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Conversionrate whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Conversionrate whereIsActive($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Conversionrate whereName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Conversionrate whereRateE2g($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Conversionrate whereRateE2u($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Conversionrate whereRateG2e($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Conversionrate whereRateG2u($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Conversionrate whereRateU2e($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Conversionrate whereRateU2g($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Conversionrate whereUpdatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Conversionrate whereUpdatedBy($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Conversionrate whereUuid($value)
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Change[] $changes
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Upload[] $uploads
 * @property-read \App\Upload $latestUpload
 */
class Conversionrate extends Basemodule
{
    use IsoModule;
    /**
    ...
    {
        $rules = [
            'name' => 'required|between:1,255|unique:conversionrates,name,' . (isset($element->id) ? "$element->id" : 'null') . ',id,deleted_at,NULL',
    ...
    {
        parent::boot();
        Conversionrate::observe(ConversionrateObserver::class);
        ...
        // completed yet.
        /************************************************************/
        // static::creating(function (Conversionrate $element) { });

        /************************************************************/
        // Following code block executes - after an element is created
        // for the first time.
        /************************************************************/
        // static::created(function (Conversionrate $element) { });
        ...
        // not yet complete.
        /************************************************************/
        // static::updating(function (Conversionrate $element) {});

        /************************************************************/
        // Following code block executes - after an element
        // is successfully updated
        /************************************************************/
        //static::updated(function (Conversionrate $element) {});

        /************************************************************/
        // Execute codes during saving (both creating and updating)
        /************************************************************/
        // static::saving(function (Conversionrate $element) {
        //     $valid = true;
        //     /************************************************************/
        ...
        /************************************************************/
        // static::saved(function (Conversionrate $element) {});
        ...
        /************************************************************/
        // static::deleting(function (Conversionrate $element) {});

        /************************************************************/
        // Following code block executes - after an element is
        // successfully deleted.
        /************************************************************/
        // static::deleted(function (Conversionrate $element) {});

        /************************************************************/
        // Following code block executes - when an already deleted element
        // is in the process of being restored.
        /************************************************************/
        // static::restoring(function (Conversionrate $element) {});

        /************************************************************/
        // Following code block executes - after an element is
        // successfully restored.
        /************************************************************/
        //static::restored(function (Conversionrate $element) {});
    }
    ...
    /**
     * Get the last added conversion rate.
     *
     * @return mixed
     */
    public static function recent()
    {
        return Conversionrate::orderBy('created_at', 'desc')->remember(cacheTime('short'))->first();
    }
