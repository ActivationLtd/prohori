...
class Department extends Basemodule
{
     ...
     * @var array
     */
    protected $fillable = ['uuid', 'name','name_BN','is_active', 'created_by', 'updated_by', 'deleted_by'];
    ...
    {
        $rules = [
            'name' => 'required|between:1,255|unique:departments,name,' . (isset($element->id) ? "$element->id" : 'null') . ',id,deleted_at,NULL',
    ...
    public static function boot()
    {
        ...
        /************************************************************/
        // static::restoring(function (Department $element) {});

        /************************************************************/
        // Following code block executes - after an element is
        // successfully restored.
        /************************************************************/
        //static::restored(function (Department $element) {});
    }
