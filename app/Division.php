 ...
 * @method static \Illuminate\Database\Query\Builder|\App\Division onlyTrashed()
 * @method static bool|null restore()
 * @method static \Illuminate\Database\Query\Builder|\App\Division withTrashed()
 * @method static \Illuminate\Database\Query\Builder|\App\Division withoutTrashed()
 * @mixin \Eloquent
...
class Division extends Basemodule
{
    ...
    {
        $rules = [
            'name' => 'required|between:1,255|unique:divisions,name,' . (isset($element->id) ? "$element->id" : 'null') . ',id,deleted_at,NULL',
            'code' => 'required|digits_between:2,2|unique:divisions,code' . (isset($element->id) ? ",$element->id" : ''),
    ...
    public static function boot()
    {
        ...
        /************************************************************/
        // static::restoring(function (Division $element) {});

        /************************************************************/
        // Following code block executes - after an element is
        // successfully restored.
        /************************************************************/
        //static::restored(function (Division $element) {});
    }
