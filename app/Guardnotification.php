...
use App\Observers\GuardnotificationObserver;
 ...
 * @method static \Illuminate\Database\Query\Builder|\App\Guardnotification onlyTrashed()
 * @method static bool|null restore()
 * @method static \Illuminate\Database\Query\Builder|\App\Guardnotification withTrashed()
 * @method static \Illuminate\Database\Query\Builder|\App\Guardnotification withoutTrashed()
 * @mixin \Eloquent
 * @property-read \App\User $creator
 * @property-read \App\User $updater
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Guardnotification newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Guardnotification newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Guardnotification query()
 */
class Guardnotification extends Basemodule
{
    //use IsoModule;
    /**
     ...
     */
    protected $fillable = [
        'uuid', 'name','user_id','title','body','response','status','user_device_token','tenant_id', 'is_active', 'created_by', 'updated_by', 'deleted_by'
    ...
    {
        $rules = [
            'name' => 'required|between:1,255|unique:guardnotifications,name,' . (isset($element->id) ? "$element->id" : 'null') . ',id,deleted_at,NULL',
    ...
    {
        parent::boot();
        Guardnotification::observe(GuardnotificationObserver::class);

        /************************************************************/
        // Execute codes during saving (both creating and updating)
        /************************************************************/
        // static::saving(function (Guardnotification $element) {
        //     $valid = true;
        //     /************************************************************/
        ...
        // completed yet.
        /************************************************************/
        // static::creating(function (Guardnotification $element) { });

        /************************************************************/
        // Following code block executes - after an element is created
        // for the first time.
        /************************************************************/
        // static::created(function (Guardnotification $element) { });
        ...
        // not yet complete.
        /************************************************************/
        // static::updating(function (Guardnotification $element) {});

        /************************************************************/
        // Following code block executes - after an element
        // is successfully updated
        /************************************************************/
        //static::updated(function (Guardnotification $element) {});

        /************************************************************/
        // Execute codes after model is successfully saved
        /************************************************************/
        // static::saved(function (Guardnotification $element) {});
        ...
        /************************************************************/
        // static::deleting(function (Guardnotification $element) {});

        /************************************************************/
        // Following code block executes - after an element is
        // successfully deleted.
        /************************************************************/
        // static::deleted(function (Guardnotification $element) {});

        /************************************************************/
        // Following code block executes - when an already deleted element
        // is in the process of being restored.
        /************************************************************/
        // static::restoring(function (Guardnotification $element) {});

        /************************************************************/
        // Following code block executes - after an element is
        // successfully restored.
        /************************************************************/
        //static::restored(function (Guardnotification $element) {});
    }
