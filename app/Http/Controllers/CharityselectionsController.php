...
class CharityselectionsController extends ModulebaseController
{
    ...
    public function gridColumns()
    {
        return [
            ...
            ["recommender.name", "user_name", "Recommender"],
            ["{$this->module_name}.charity_name", "charity_name", "Charity"],
            ["{$this->module_name}.share_percentage", "share_percentage", "Share(%)"],
    ...
    public function sourceTables()
    {
        return DB::table($this->module_name)
            ->leftJoin('users as recommender', $this->module_name . '.user_id', 'recommender.id');
    }
