...
class PushnotificationsController extends ModulebaseController
{
    ...
    public function gridColumns()
    {
        return [
            ...
            ["{$this->module_name}.message", "message", "Message"],
            ["{$this->module_name}.multicast_id", "multicast_id", "Multicast ID"],
            ["{$this->module_name}.success_count", "success_count", "Success count"],
            ["{$this->module_name}.failure_count", "failure_count", "Failure"],
