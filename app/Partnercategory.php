...
use App\Observers\PartnercategoryObserver;
 ...
 * @method static \Illuminate\Database\Query\Builder|\App\Partnercategory onlyTrashed()
 * @method static bool|null restore()
 * @method static \Illuminate\Database\Query\Builder|\App\Partnercategory withTrashed()
 * @method static \Illuminate\Database\Query\Builder|\App\Partnercategory withoutTrashed()
 * @mixin \Eloquent
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Partnercategory newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Partnercategory newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Partnercategory query()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Partnercategory whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Partnercategory whereCreatedBy($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Partnercategory whereDeletedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Partnercategory whereDeletedBy($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Partnercategory whereDescription($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Partnercategory whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Partnercategory whereIsActive($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Partnercategory whereName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Partnercategory whereOrder($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Partnercategory whereParentId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Partnercategory whereSlug($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Partnercategory whereTenantId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Partnercategory whereUpdatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Partnercategory whereUpdatedBy($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Partnercategory whereUuid($value)
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Change[] $changes
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Upload[] $uploads
 * @property-read \App\Upload $latestUpload
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Partner[] $partners
 */
class Partnercategory extends Basemodule
{
    use IsoModule;
    /**
    ...
    {
        $rules = [
            'name' => 'required|between:1,255|unique:partnercategories,name,' . (isset($element->id) ? "$element->id" : 'null') . ',id,deleted_at,NULL',
    ...
    {
        parent::boot();
        Partnercategory::observe(PartnercategoryObserver::class);
        ...
        // completed yet.
        /************************************************************/
        // static::creating(function (Partnercategory $element) { });

        /************************************************************/
        // Following code block executes - after an element is created
        // for the first time.
        /************************************************************/
        // static::created(function (Partnercategory $element) { });
        ...
        // not yet complete.
        /************************************************************/
        // static::updating(function (Partnercategory $element) {});

        /************************************************************/
        // Following code block executes - after an element
        // is successfully updated
        /************************************************************/
        //static::updated(function (Partnercategory $element) {});

        /************************************************************/
        // Execute codes during saving (both creating and updating)
        /************************************************************/
        // static::saving(function (Partnercategory $element) {
        //     $valid = true;
        //     /************************************************************/
        ...
        /************************************************************/
        // static::saved(function (Partnercategory $element) {});
        ...
        /************************************************************/
        // static::deleting(function (Partnercategory $element) {});

        /************************************************************/
        // Following code block executes - after an element is
        // successfully deleted.
        /************************************************************/
        // static::deleted(function (Partnercategory $element) {});

        /************************************************************/
        // Following code block executes - when an already deleted element
        // is in the process of being restored.
        /************************************************************/
        // static::restoring(function (Partnercategory $element) {});

        /************************************************************/
        // Following code block executes - after an element is
        // successfully restored.
        /************************************************************/
        //static::restored(function (Partnercategory $element) {});
    }
    ...
    /**
     * Get a list of active partner categories
     * @param string $cache_time
     * @return mixed
     */
    public static function getActiveList($cache_time = 'short')
    {
        return Partnercategory::where('is_active', 1)
            ->orderBy('order', 'ASC')
            ->orderBy('name', 'ASC')
            ->remember(cacheTime($cache_time))->get();
    }
    ...
    */
    ...
    {
        return $this->hasMany(Partner::class)->where('is_active', 1)
