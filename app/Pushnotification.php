 ...
 * @method static \Illuminate\Database\Query\Builder|\App\Pushnotification onlyTrashed()
 * @method static bool|null restore()
 * @method static \Illuminate\Database\Query\Builder|\App\Pushnotification withTrashed()
 * @method static \Illuminate\Database\Query\Builder|\App\Pushnotification withoutTrashed()
 * @mixin \Eloquent
 * @property string|null $message
 * @property string|null $multicast_id
 * @property int|null $success_count
 * @property int|null $failure_count
 * @property-read \App\User|null $creator
 * @property-read \App\User|null $updater
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Pushnotification newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Pushnotification newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Pushnotification query()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Pushnotification whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Pushnotification whereCreatedBy($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Pushnotification whereDeletedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Pushnotification whereDeletedBy($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Pushnotification whereFailureCount($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Pushnotification whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Pushnotification whereIsActive($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Pushnotification whereMessage($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Pushnotification whereMulticastId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Pushnotification whereName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Pushnotification whereSuccessCount($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Pushnotification whereTenantId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Pushnotification whereUpdatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Pushnotification whereUpdatedBy($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Pushnotification whereUuid($value)
...
class Pushnotification extends Basemodule
{
    ...
    {
        $rules = [
            'name' => 'required|between:1,255|unique:pushnotifications,name,' . (isset($element->id) ? "$element->id" : 'null') . ',id,deleted_at,NULL',
    ...
    public static function boot()
    {
        ...
        /************************************************************/
        // static::restoring(function (Pushnotification $element) {});

        /************************************************************/
        // Following code block executes - after an element is
        // successfully restored.
        /************************************************************/
        //static::restored(function (Pushnotification $element) {});
    }
