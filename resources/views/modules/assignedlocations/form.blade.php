 ...
 * @var $module_name           string 'assignedlocations'
 * @var $mod                   \App\Module
 * @var $Assignedlocation             \App\Assignedlocation Object that is being edited
 * @var $element               string 'Assignedlocation'
...
@include('form.select-model', ['var'=>['name'=>'user_id','label'=>'User','query'=> new \App\User,'container_class'=>'col-md-6']])
...
<div class="clearfix"></div>
@include('form.input-text',['var'=>['name'=>'from','label'=>'From', 'container_class'=>'col-sm-2','params'=>['id'=>'from']]])
@include('form.input-text',['var'=>['name'=>'till','label'=>'Till', 'container_class'=>'col-sm-2','params'=>['id'=>'till']]])
<div class="clearfix"></div>
{{-- Model select --}}
...
@section('js')
    ...
    @if(!isset($$element))
        <script type="text/javascript">
            ...
            // during creation of an element. As this stage $$element or $Assignedlocation(module
    ...
    @else
        <script type="text/javascript">
            ...
            // during update the variable $$element or $Assignedlocation(module
            // name singular) is set, and id like other attributes of the element can be
            // accessed by calling $$element->id, also $Assignedlocation->id
            // Following the convention of spyrframe you are only allowed to call functions
            /*******************************************************************/
