...
@section('content')
    ...
    <h2>Last updated: 07-13-2019</h2>

    <p>My Company Prohori operates https://prohori-staging.activationltd.com. This page informs you of our policies regarding the collection, use and disclosure of Personal Information we receive from users of the Site.
    ...
    In addition, we may use third party services such as Google Analytics that collect, monitor and analyze this …
        ...
        The Log Data section is for businesses that use analytics or tracking services in websites or apps, like Google Analytics.</p>
    ...
    <p>This Privacy Policy is effective as of 07-13-2019 and will remain in effect except with respect to any changes in its provisions in the future, which will be in effect immediately after being posted on this page.
