...
@if(isset($beacon))
    <h4 class="">Beacon analyzer </h4>
    <div class="col-md-6 no-padding-l">
        <h6>Original Beacon (JSON)</h6>
        <?php Symfony\Component\VarDumper\VarDumper::dump(json_decode($beacon->data)); ?>

        <h6>'purchases' table entries (Array)</h6>
        <?php Symfony\Component\VarDumper\VarDumper::dump(json_decode($beacon->purchases)); ?>
    </div>
    <div class="col-md-6 no-padding-l">
        <h6>Products common in both - recommendation(s) and purchases(s) (Array)</h6>
        <?php Symfony\Component\VarDumper\VarDumper::dump($beacon->productsInBothPurchaseAndRecommendation()) ?>
