 ...
 * @var $module_name           string 'clientlocations'
 * @var $mod                   \App\Module
 * @var $clientlocation             \App\Clientlocation Object that is being edited
 * @var $element               string 'clientlocation'
...
@include('form.select-model',['var'=>['name'=>'clientlocationtype_id','label'=>'Clientlocation Type','table'=>'clientlocationtypes', 'container_class'=>'col-sm-3']])
<div class="clearfix"></div>
...
@section('js')
    ...
    @if(!isset($$element))
        <script type="text/javascript">
            ...
            // during creation of an element. As this stage $$element or $clientlocation(module
    ...
    @else
        <script type="text/javascript">
            ...
            // during update the variable $$element or $clientlocation(module
            // name singular) is set, and id like other attributes of the element can be
            // accessed by calling $$element->id, also $clientlocation->id
            // Following the convention of spyrframe you are only allowed to call functions
            /*******************************************************************/
