 ...
 * @var $module_name           string 'departments'
 * @var $mod                   \App\Module
 * @var $department             \App\Department Object that is being edited
 * @var $element               string 'department'
...
@include('form.input-text',['var'=>['name'=>'name_BN','label'=>'Bangla name']])
...
@section('js')
    ...
    @if(!isset($$element))
        <script type="text/javascript">
            ...
            // during creation of an element. As this stage $$element or $department(module
    ...
    @else
        <script type="text/javascript">
            ...
            // during update the variable $$element or $department(module
            // name singular) is set, and id like other attributes of the element can be
            // accessed by calling $$element->id, also $department->id
            // Following the convention of spyrframe you are only allowed to call functions
            /*******************************************************************/
