 ...
 * @var $module_name           string 'guardnotifications'
 * @var $mod                   \App\Module
 * @var $guardnotification             \App\Guardnotification Object that is being edited
 * @var $element               string 'guardnotification'
...
{{-- Normal text field --}}
@include('form.select-model',['var'=>['name'=>'user_id','label'=>'User','table'=>'users']])
<div class="clearfix"></div>

@include('form.input-text',['var'=>['name'=>'title','label'=>'Title']])
<div class="clearfix"></div>
@include('form.textarea',['var'=>['name'=>'body','label'=>'Body','container_class'=>'col-md-8']])
<div class="clearfix"></div>
@include('form.input-text',['var'=>['name'=>'response','label'=>'Response']])
@include('form.select-array',['var'=>['name'=>'status','label'=>'Status','options'=>$status]])
...
@section('js')
    ...
    @if(!isset($$element))
        <script type="text/javascript">
            ...
            // during creation of an element. As this stage $$element or $guardnotification(module
    ...
    @else
        <script type="text/javascript">
            ...
            // during update the variable $$element or $guardnotification(module
            // name singular) is set, and id like other attributes of the element can be
            // accessed by calling $$element->id, also $guardnotification->id
            // Following the convention of spyrframe you are only allowed to call functions
            /*******************************************************************/
